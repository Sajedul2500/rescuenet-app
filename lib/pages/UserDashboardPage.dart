          ...
          child: Row(
            ...
            children: [
              _buildNavItem(
                ...
                label: 'Contacts',
                index: 0,
                onTap: () => _navigateToPage(const EmergencyContactPage()),
              ),
              _buildNavItem(
                icon: Icons.chat,
                label: 'AI Chat',
                index: 1,
                onTap: () => _navigateToPage(const AIChatBotPage()),
              ),
              _buildCenterFAB(),
              _buildNavItem(
                icon: Icons.history,
                label: 'History',
                index: 3,
                onTap: () => _navigateToPage(const HelpRequestHistoryPage()),
              ),
              _buildNavItem(
                icon: Icons.person,
                label: 'Profile',
                index: 4,
                onTap: () => _navigateToPage(const UserProfilePage()),
              ),
            ],
          ),
        ),
